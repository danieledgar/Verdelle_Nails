...
const Dashboard = () => {
  ...
  const getProfilePictureUrl = () => {
    ...
    // Handle Django media URL format - remove the extra /api from API_BASE
    const baseUrl = API_BASE.replace('/api', '') || BACKEND_BASE;
    ...
    // If it doesn't start with /media/ but is a relative path
...
// Styled Components (Keep exactly the same as your original)
